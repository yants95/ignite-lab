...
export type MeQuery = { __typename?: 'Query', me: Array<{ __typename?: 'User', enrollments: Array<{ __typename?: 'Enrollment', id: string, created_at: any, course: { __typename?: 'Course', title: string, slug: string } }> }> };
...
export const CreatePurchaseDocument = gql`
  ...
  createPurchase(params: {productId: $productId}) {
    id
  }
}
    `;
